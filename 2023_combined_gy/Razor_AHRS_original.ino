...
#define ACCEL_X_MIN ((float) -198)
#define ACCEL_X_MAX ((float) 327)
#define ACCEL_Y_MIN ((float) -288)
#define ACCEL_Y_MAX ((float) 336)
#define ACCEL_Z_MIN ((float) -491)
#define ACCEL_Z_MAX ((float) 278)

// Magnetometer (standard calibration mode)
// "magn x,y,z (min/max) = X_MIN/X_MAX  Y_MIN/Y_MAX  Z_MIN/Z_MAX"
#define MAGN_X_MIN ((float) -384)
#define MAGN_X_MAX ((float) 942)
#define MAGN_Y_MIN ((float) -1616)
#define MAGN_Y_MAX ((float) -55)
#define MAGN_Z_MIN ((float) -1350)
#define MAGN_Z_MAX ((float) 403)
...
#define GYRO_AVERAGE_OFFSET_X ((float) 22.52)
#define GYRO_AVERAGE_OFFSET_Y ((float) -180.34)
#define GYRO_AVERAGE_OFFSET_Z ((float) 130.41)
...
//  Serial.print("     ");
  double write_time = TO_DEG(yaw) * 3.0 + 600.0;
